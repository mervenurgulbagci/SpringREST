...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.merve")
@PropertySource("classpath:db.properties")
public class SpringRestAppConfig {
	@Autowired
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.merve.domain" });
